  ...
  return (
    <div className="pt-32 pb-20 min-h-screen px-4 max-w-7xl mx-auto flex flex-col items-center">
      <div className="text-center max-w-3xl mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-slate-800 tracking-tight">Botox & <span className="text-amber-600">Fillers</span></h1>
        <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
          Experience our world-class botox & fillers specifically tailored for your needs.
            ...
            <div className="p-5">
              ...
              <div className="mt-5 grid grid-cols-2 gap-3 text-center">
                <div className="bg-slate-50 p-3 rounded-2xl border border-slate-100">
                  ...
                  <p className="text-slate-500 text-xs mt-1">Deep Wrinkles</p>
                </div>
                <div className="bg-amber-50 p-3 rounded-2xl border border-amber-100">
                  <h3 className="text-sm font-bold text-amber-700">After</h3>
                  <p className="text-amber-500 text-xs mt-1">Relaxed Face</p>
                </div>
              </div>
            </div>
          </div>
