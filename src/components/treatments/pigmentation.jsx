  ...
  return (
    <div className="pt-32 pb-20 min-h-screen px-4 max-w-7xl mx-auto flex flex-col items-center">
      <div className="text-center max-w-3xl mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-slate-800 tracking-tight">Pigmentation <span className="text-amber-600">Treatment</span></h1>
        <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
          Dramatically reduce the appearance of dark spots, melasma, and uneven skin tone. 
          Our targeted therapies safely break down excess melanin, revealing a brighter, beautifully unified complexion.
        </p>
      </div>

      <div className="w-full grid lg:grid-cols-3 gap-8">
        {[
          { img: "/images/pigmentation_before_after.png", b: "Uneven texture", a: "Luminous skin" },
          { img: "/images/pigmentation_before_after_2.png", b: "Hyperpigmentation", a: "Radiant tone" },
          { img: "/images/pigmentation_before_after_3.png", b: "Sun damage", a: "Unified complexion" }
        ].map((item, index) => (
          <div key={index} className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-amber-900/5 border border-slate-100 transition-all duration-300 hover:shadow-amber-900/15 hover:-translate-y-1">
            ...
            <div className="p-5">
              <img 
                src={item.img} 
                alt={`Before and After Pigmentation Treatment ${index + 1}`} 
